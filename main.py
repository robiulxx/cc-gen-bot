...
TOKEN = os.getenv("BOT_TOKEN")  # Render Dashboard এ Environment Variable এ সেট করবে
APP_URL = os.getenv("APP_URL")  # যেমন: https://your-app.onrender.com
...
@app.route("/")
def home():
    return "Bot is online via Webhook!"

# --- Main ---
if __name__ == "__main__":
    # প্রথমবার চালালে Webhook সেট করতে হবে
    import asyncio
